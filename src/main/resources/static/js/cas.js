...
function validateUserName() {
    var userNameVal = $.trim($('input[name="username"]').val());
    return userNameVal !== '';
}

function validatePwd() {
    var pwdVal = $.trim($('input[name="password"]').val());
    return pwdVal !== '';
}

function validateCode() {
    var capchaVal = $.trim($('input[name="capcha"]').val());
    return capchaVal !== '';
}


function onLogin() {
    return (validateUserName() && validatePwd() && validateCode());
}
